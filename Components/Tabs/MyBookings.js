...
import { View, StyleSheet, TextInput, Text, Image, Dimensions, TouchableOpacity, FlatList, ScrollView, ViewPropTypes} from 'react-native';
    ...
    return (
      <ScrollView>
        ...
        <View style = {{flexDirection:'row',marginHorizontal:20, marginVertical:20, alignSelf:'flex-start'}}>
          <Text style = {{ color:colors.black, fontWeight:'bold', fontSize:24 }}>MY BOOKINGS</Text>
        </View>
        <View style = {{flexDirection:'row',marginHorizontal:20, alignSelf:'flex-start'}}>
          <Text style = {{ color:colors.black, fontWeight:'bold', fontSize:16 }}>UPCOMING:</Text>
        </View>
        ...
        <View style = {{flexDirection:'row',marginHorizontal:20, alignSelf:'flex-start'}}>
          <Text style = {{ color:colors.black, fontWeight:'bold', fontSize:16 }}>PREVIOUS BOOKINGS</Text>
        </View>
        <View style = {styles.previousBookings}>
          <View style = {{paddingHorizontal:35, paddingVertical:10}}>
            <Text style = {{fontSize:11, color:colors.secondary}}>N O V</Text>
