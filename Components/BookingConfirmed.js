    ...
    return (
      <View style = {{ flex:1, justifyContent:'center', alignItems:'center',}}>
        <View style = {{ marginLeft:80, marginRight:100, flexDirection:'row'}}>
            <Text style = {{fontSize:28, fontWeight:'bold'}}>YOUR BOOKING IS CONFIRMED!</Text>
        ...
        <View style = {{flexDirection:'row', alignSelf:'baseline', marginTop:30, marginLeft:30}}>
            ...
            <View style = {{width:Dimensions.get('window').width/2}}>
                <Text style = {{fontSize:14, fontWeight:'bold'}}>{this.state.name}</Text>
        ...
        <View style = {{alignSelf:'flex-start', marginLeft:30, marginTop:30, marginBottom:50}}>
            <Text style = {{color:colors.primary, textDecorationLine:'underline', fontWeight:'bold' }}>ADD TO MY CALANDER</Text>
        </View>
