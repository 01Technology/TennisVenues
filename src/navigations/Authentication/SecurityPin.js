                ...
                <View style = {styles.boxContainer}> 
                    ...
                    <View>
                        <Button 
                            ...
                            title="CONFIRM" 
                            buttonStyle={{alignSelf:'center',width:160,height:45, backgroundColor: colors.primary, borderRadius:50, }} 
                            onPress={() => { this.confirmPressed() ; }}
                            titleStyle = {{fontSize:16, fontWeight:'100', fontFamily:'Lato-Regular'}}
                        />
                    </View>
                </View>
        );
